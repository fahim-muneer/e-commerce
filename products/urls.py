...
urlpatterns = [
    ...
    path('<pk>/product_update/',ProductUpdate.as_view(),name="product_update"),
    path('<pk>/product_delete/',ProductDelete.as_view(),name="product_delete"),
    path('<pk>/product_details/',ProductDetail.as_view(),name="product_details"),
