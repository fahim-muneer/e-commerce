...
path('admin/profile/',staff_member_required(AdminProfileView.as_view()),name='admin_profile'),
path('verify/email/otp/',staff_member_required(VerifyEmailOtpView.as_view()),name='verify_email_otp'),
